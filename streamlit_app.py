...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("<div style='font-size:11px;color:rgba(255,255,255,.4)'><b style='color:rgba(255,255,255,.7)'>Vishwaroop Galgali</b><br>PGDM RBA 2<br><br>Superstore 2014-2017<br>9,994 txns · 793 customers</div>", unsafe_allow_html=True)
